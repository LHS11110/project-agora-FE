  ...
  return <div className="hero-board-wrap" aria-label="Agora 협업 캔버스 미리보기">
    ...
    <div className="hero-board">
      ...
      <div className="mini-board-canvas">
        ...
        <div className="mini-scribble" aria-hidden="true"><svg viewBox="0 0 150 100"><path className="mini-scribble-path" d="M8 75 C20 53 39 45 53 57 S78 89 96 54 S119 24 137 31" pathLength="1" /><path className="mini-scribble-arrow" d="M126 21l13 10-15 4" /><g className="mini-scribble-pen"><path d="M0 0l13 13-5 1-3 6-2-6-4-2z" /><animateMotion dur="5.6s" repeatCount="indefinite" rotate="auto" path="M8 75 C20 53 39 45 53 57 S78 89 96 54 S119 24 137 31" /></g></svg></div>
        <div className="mini-photo"><div className="photo-sun" /><div className="photo-hill one" /><div className="photo-hill two" /></div>
        <div className="mini-code"><div><i /><i /><i /></div><code><b>const</b> idea = <em><span className="mini-typing">together</span></em>;</code><code>makeSomethingGood();</code></div>
        <div className="mini-cursor"><span />지수</div>
        <div className="mini-drag-cursor" aria-hidden="true"><svg viewBox="0 0 18 23"><path d="M1 1v18l5-4.5 3 6 3-1.5-3-6.2h7z" /></svg><span>민지 · 이동 중</span></div>
